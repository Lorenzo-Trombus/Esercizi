...
indice_lepre=13
indice_tartaruga=15
posizione_lepre=percorso[indice_lepre]
posizione_tartaruga=percorso[indice_tartaruga]
print("BANG!!!!!! AND THEY'RE OFF!!!!")
percorso_grafico=list(range(1,71))

def posizioni_sul_percorso():
    
    for i in percorso_grafico:
        if i==posizione_lepre and posizione_lepre==posizione_tartaruga:
            i="OUCH!!!"
        elif percorso_grafico.index(i)==posizione_tartaruga:
            i="T"
        elif percorso_grafico.index(i)==posizione_lepre:
            i="H"
        else:
            i="_"
