...
panino=sandwich(["hamburger","pomodori","insalata"])
sandwich(["formaggio","hamburger"])
sandwich(ingredienti=["hamburger"])
...
"""
def build_profile(firstname:str,lastname:str,age:int,hair:str,weight:int):
    return f"{firstname} {lastname}, age {age}, hair {hair}, weight {weight}"
profile=build_profile("lorenzo","trombini",19,"brown",75)
print(profile)
"""
