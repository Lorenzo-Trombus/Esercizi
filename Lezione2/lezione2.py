...
• Use pop() to remove guests from your list one at a time until only two names remain in your list.
 Each time you pop a name from your list, print a message to that person letting them know you’re sorry you can’t invite them 
 to dinner.
...
for i in range(len(invitati)-2):
    invitati.pop(0)
    print(f"sorry {invitati[0]}, you are not invited to dinner anyore")
...
print("there will be only two seats at the table")
...
"""
places_to_visit=["maldive","hawaii","amsterdam","bruges","hollywood"]
